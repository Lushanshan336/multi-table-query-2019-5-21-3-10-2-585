...
where student.id = student_course.id and student_course.courseld = '1' and exists
    (Select 1 from student_course student_course_2 
     where student_course_2.id = student_course.id and student_course_2.courseld= '2' 
     order by student.id
